...
from auto.carlo import carlo
from bson import ObjectId
from pymongo import MongoClient

from auto.utils import send_telegram_message
...
def run_all_wfa(alpha_id: str):
    ...
    try:
        ...
        msg = (
            f"WFA Group {alpha.get('group','').replace('%20',' ')} Name: {alpha.get('name','')} :\n"
            "Import: ✅\n"
            "Filter: ✅\n"
            "Running: Done ✅"
            f"🔗 http://103.253.20.31:8080/alpha-backtest/{alpha_id}"
        )
